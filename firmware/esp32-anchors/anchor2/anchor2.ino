...
void setup() {
    ...
    IPAddress local_IP(10, 19, 96, 12);
    ...
    Serial.println("=====================================");
    Serial.println("  ANCHOR 2 READY (UDP CLIENT)");
    Serial.println("=====================================");
}
...
void loop() {
            ...
            if (memcmp(rx_buffer, rx_resp_msg, ALL_MSG_COMMON_LEN) == 0) {
                ...
                if (filtered >= 0) {
                    ...
                    if (WiFi.status() == WL_CONNECTED) {
                        ...
                        char msg[32];
                        sprintf(msg, "ANCHOR2: %.2f", filtered);
                        udp.print(msg);
                        udp.endPacket();
                    }
                    
                    Serial.print("ANCHOR 2 DIST: ");
    ...
    // Add slight random jitter to prevent continuous collisions with Anchor 1 and Hub
