...
#define EVB1000_LCD_SUPPORT 0
     ...
     *     proper handler is set by calling this function before any DW3xxx/QM33xx IRQ occurs!
     *   - This function makes sure the DW3xxx/QM33xx IRQ line is deactivated while the handler is installed.
     *
     * @param deca_isr function pointer to DW3xxx/QM33xx interrupt handler to install
     *
     * @return none
     */
...
#define DECAIRQ_EXTI_IRQn        (EXTI14_IRQn)

#define DW_RSTn      UWB_RST_Pin
#define DW_RSTn_GPIO UWB_RST_GPIO_Port

#define DECAIRQ                     UWB_IRQ_Pin
#define DECAIRQ_GPIO                UWB_IRQ_GPIO_Port
...
#define port_SPIx_set_chip_select()   HAL_GPIO_WritePin(UWB_CS_GPIO_Port, UWB_CS_Pin, GPIO_PIN_SET)
#define port_SPIx_clear_chip_select() HAL_GPIO_WritePin(UWB_CS_GPIO_Port, UWB_CS_Pin, GPIO_PIN_RESET)
...
#define SET_WAKEUP_PIN_IO_LOW     HAL_GPIO_WritePin(UWB_CS_GPIO_Port, UWB_CS_Pin, GPIO_PIN_RESET)
#define SET_WAKEUP_PIN_IO_HIGH    HAL_GPIO_WritePin(UWB_CS_GPIO_Port, UWB_CS_Pin, GPIO_PIN_SET)
